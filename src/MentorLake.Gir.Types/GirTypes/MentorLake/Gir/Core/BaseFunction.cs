...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("BaseFunction", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("function", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [XmlIncludeAttribute(typeof(Method))]
    [XmlIncludeAttribute(typeof(VirtualMethod))]
    public partial class BaseFunction : InfoElements, ICallableAttrs
    {
