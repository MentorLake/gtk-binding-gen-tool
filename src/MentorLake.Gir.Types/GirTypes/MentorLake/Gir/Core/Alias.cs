...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("alias", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("alias", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Alias : InfoElements, IInfoAttrs, ICType
    {
        ...
        /// <summary>
        /// <para>the new name or typedef'd name</para>
        /// </summary>
        [DescriptionAttribute("the new name or typedef\'d name")]
