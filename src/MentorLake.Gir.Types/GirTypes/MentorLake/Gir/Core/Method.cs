...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("method", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("method", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Method : BaseFunction
    {
        
        [XmlAttributeAttribute("set-property", Namespace="http://www.gtk.org/introspection/glib/1.0", Form=XmlSchemaForm.Qualified)]
        public string SetProperty { get; set; }
        
        [XmlAttributeAttribute("get-property", Namespace="http://www.gtk.org/introspection/glib/1.0", Form=XmlSchemaForm.Qualified)]
