...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("prerequisite", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("prerequisite", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Prerequisite
    {
        
        /// <summary>
        /// <para>name of the required interface</para>
        /// </summary>
        [DescriptionAttribute("name of the required interface")]
