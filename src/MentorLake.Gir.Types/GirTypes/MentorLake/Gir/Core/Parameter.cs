...
namespace MentorLake.Gir.Core
{
    ...
    /// <summary>
    /// <para>parameter element of a list of parameters</para>
    /// </summary>
    [DescriptionAttribute("parameter element of a list of parameters")]
    [GeneratedCodeAttribute("XmlSchemaClassGenerator", "2.1.1174.0")]
    [SerializableAttribute()]
    [XmlTypeAttribute("parameter", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("parameter", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Parameter : BaseParam
    {
    }
}
