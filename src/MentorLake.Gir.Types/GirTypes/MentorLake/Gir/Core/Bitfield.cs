...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("bitfield", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("bitfield", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Bitfield : InfoElements, IInfoAttrs, ICType, MentorLake.Gir.GLib.ITypeName3, MentorLake.Gir.GLib.IGetType3
    {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Bitfield" /> class.</para>
        /// </summary>
        public Bitfield()
        {
        ...
        /// <summary>
        /// <para>name of the bit field</para>
        /// </summary>
        [DescriptionAttribute("name of the bit field")]
