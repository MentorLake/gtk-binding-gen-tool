...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("ReturnValueTransferOwnership", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    public enum ReturnValueTransferOwnership
    {
        
        [XmlEnumAttribute("none")]
        None,
        
        [XmlEnumAttribute("container")]
        Container,
