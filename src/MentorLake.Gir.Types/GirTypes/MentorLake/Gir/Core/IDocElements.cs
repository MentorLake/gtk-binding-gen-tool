...
namespace MentorLake.Gir.Core
{
    ...
    public partial interface IDocElements
    {
        
        List<DocVersion> DocVersion
        {
            get;
        }
        
        List<DocStability> DocStability
        {
            get;
        }
        ...
        List<DocDeprecated> DocDeprecated
        {
            get;
        }
        
        List<SourcePosition> SourcePosition
        {
            get;
        }
    }
