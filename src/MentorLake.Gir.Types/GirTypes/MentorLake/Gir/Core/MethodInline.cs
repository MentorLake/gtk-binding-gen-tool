...
namespace MentorLake.Gir.Core
{
    ...
    /// <summary>
    /// <para>element defining an inline method from a type</para>
    /// </summary>
    [DescriptionAttribute("element defining an inline method from a type")]
    [GeneratedCodeAttribute("XmlSchemaClassGenerator", "2.1.1174.0")]
    [SerializableAttribute()]
    [XmlTypeAttribute("method-inline", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("method-inline", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class MethodInline : InfoElements, ICallableAttrs
    {
