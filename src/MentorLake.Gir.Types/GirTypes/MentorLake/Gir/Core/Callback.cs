...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("callback", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("callback", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Callback : InfoElements, IInfoAttrs
    {
        ...
        /// <summary>
        /// <para>name of the callback</para>
        /// </summary>
        [DescriptionAttribute("name of the callback")]
        ...
        /// <summary>
        /// <para>Binary attribute, true if the callback can throw an error</para>
        /// </summary>
        [DescriptionAttribute("Binary attribute, true if the callback can throw an error")]
        [XmlAttributeAttribute("throws")]
        public CallbackThrows Throws { get; set; }
