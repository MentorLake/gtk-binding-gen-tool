...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("implements", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("implements", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Implements
    {
        
        /// <summary>
        /// <para>name of the interface implemented by a class</para>
        /// </summary>
        [DescriptionAttribute("name of the interface implemented by a class")]
