...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("ReturnValueScope", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    public enum ReturnValueScope
    {
        
        [XmlEnumAttribute("notified")]
        Notified,
        
        [XmlEnumAttribute("async")]
        Async,
        
        [XmlEnumAttribute("call")]
        Call,
        
        [XmlEnumAttribute("forever")]
        Forever,
    }
}
