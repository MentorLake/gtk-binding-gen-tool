...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("BaseParamDirection", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    public enum BaseParamDirection
    {
        
        [XmlEnumAttribute("out")]
        Out,
        
        [XmlEnumAttribute("in")]
        In,
        
        [XmlEnumAttribute("inout")]
        Inout,
    }
}
