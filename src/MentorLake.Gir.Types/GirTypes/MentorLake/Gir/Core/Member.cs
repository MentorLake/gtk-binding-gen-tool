...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("member", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("member", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Member : InfoElements, IInfoAttrs, MentorLake.Gir.C.IIdentifier2
    {
        ...
        /// </summary>
        [DescriptionAttribute("name of the member")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlAttributeAttribute("name")]
        public string Name { get; set; }
        
        /// <summary>
        /// <para>value of the member</para>
        /// </summary>
        [DescriptionAttribute("value of the member")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlAttributeAttribute("value")]
        public string Value { get; set; }
        
        /// <summary>
        /// <para>corresponding C type of the member</para>
        /// </summary>
        [DescriptionAttribute("corresponding C type of the member")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlAttributeAttribute("identifier", Namespace="http://www.gtk.org/introspection/c/1.0", Form=XmlSchemaForm.Qualified)]
        public string Identifier { get; set; }
        
        [XmlAttributeAttribute("nick", Namespace="http://www.gtk.org/introspection/glib/1.0", Form=XmlSchemaForm.Qualified)]
