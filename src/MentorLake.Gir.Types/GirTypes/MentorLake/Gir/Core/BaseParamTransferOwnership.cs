...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("BaseParamTransferOwnership", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    public enum BaseParamTransferOwnership
    {
