...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("package", Namespace="http://www.gtk.org/introspection/core/1.0", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("package", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Package
    {
        
        /// <summary>
        /// <para>name of the pkg-config file, minus the extension</para>
        /// </summary>
        [DescriptionAttribute("name of the pkg-config file, minus the extension")]
