...
namespace MentorLake.Gir.Core
{
    ...
    [XmlTypeAttribute("constant", Namespace="http://www.gtk.org/introspection/core/1.0")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("constant", Namespace="http://www.gtk.org/introspection/core/1.0")]
    public partial class Constant : InfoElements, IInfoAttrs, MentorLake.Gir.C.IIdentifier
    {
        ...
        /// </summary>
        [DescriptionAttribute("name of the constant")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlAttributeAttribute("name")]
        public string Name { get; set; }
        
        /// <summary>
        /// <para>value of the constant</para>
        /// </summary>
        [DescriptionAttribute("value of the constant")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        ...
        /// <summary>
        /// <para>corresponding C identifier in the source code</para>
        /// </summary>
        [DescriptionAttribute("corresponding C identifier in the source code")]
        [RequiredAttribute(AllowEmptyStrings=true)]
