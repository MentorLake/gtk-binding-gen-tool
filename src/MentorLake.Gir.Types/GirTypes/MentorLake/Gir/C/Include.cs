...
namespace MentorLake.Gir.C
{
    ...
    [XmlTypeAttribute("include", Namespace="http://www.gtk.org/introspection/c/1.0", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("include", Namespace="http://www.gtk.org/introspection/c/1.0")]
    public partial class Include
    {
        
        /// <summary>
        /// <para>File name of the C header file. The path can be relative.</para>
        /// </summary>
        [DescriptionAttribute("File name of the C header file. The path can be relative.")]
